#ifndef ROBIN_FIRMWARE_INTERFACE_H
#define ROBIN_FIRMWARE_INTERFACE_H
#include <boost/asio.hpp>
#include <robin_firmware_cpp/command_codes.h>
#include <robin_firmware_cpp/firmware_definitions.h>
#include <robin_firmware_cpp/imu_reading.h>
#include <robin_firmware_cpp/motor_command.h>
#include <optional>
#include <mutex>
...
public:
  Interface() : serial_(io_, SERIAL_PORT) {
    // Set options
    serial_.set_option(
        boost::asio::serial_port_base::baud_rate(SERIAL_BAUD_RATE));
  ...
  bool sendMotorCommands(const robin_firmware::MotorCommand &left_motor_cmd,
    ...
    const char cmd_byte[2]{
        robin_firmware::CMD_ACTIVATE_MOTOR_MASK |
            robin_firmware::CMD_READ_IMU_MASK,
...
#endif // ROBIN_FIRMWARE_INTERFACE_H
